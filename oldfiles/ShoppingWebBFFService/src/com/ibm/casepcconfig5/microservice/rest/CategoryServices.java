...
public class CategoryServices extends Application {
	...
	public Response getCategory(@HeaderParam("authorization") String authString, @PathParam(value = "id") int categoryId) {
		return invokeRest(Constants.CATEGORY_ID_URL + categoryId, authString, "GET", null, null);
	}

	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public Response loadTopLevelCategories(@HeaderParam("authorization") String authString) {
		return invokeRest(Constants.CATEGORY_URL, authString, "GET", null, null);
	}

	private Response invokeRest(String urlStr, String authString, String type, HttpHeaders headers, InputStream is) {
